...
protocol NavigationDestinationFactory {
	...
	@MainActor
	func destination(for navItem: NavItem, in mode: MNavContainer.Mode) -> any View
...
extension AppDependencies: NavigationDestinationFactory {
	...
	@MainActor
	private func destinationBase(for navItem: NavItem, in mode: MNavContainer.Mode) -> any View {
		switch navItem {
	...
	@MainActor
	private func destinationDefault(for navItem: NavItem, in mode: MNavContainer.Mode) -> any View {
